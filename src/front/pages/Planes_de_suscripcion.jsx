...
const Planes_de_suscripcion = () => {
  ...
  // para que cuando cargue los planes salga un mensaje de carga
  const [loading, setLoading] = useState(true);
  // Estado para error de carga de planes o con la Api
  ...
  const handlePlan = (plan) => {
    ...
    // nos redireciona a encuesta y le decimos que plan hemos elegido
